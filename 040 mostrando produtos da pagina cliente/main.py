...
def index():
    ...
    return render_template('home.html',usuarioLogado=usuarioLogado,logado=logado, listaDeClientes=listaDeClientes, listaDeVendedor=listaDeVendedor)
        ...
        with open('clientes.json') as cliente_json:
            ...
            for usuario in listaDeClientes:
                if usuario['email'] == session['cliente']:
                    ...
                    return render_template('cliente.html',listaVendedores=listaVendedores,dados_cliente=dados_cliente, foto=foto, nome=nome, email=email)
    else:
